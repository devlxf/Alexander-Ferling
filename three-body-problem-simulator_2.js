(function(){
  ...
  var graphics = (function() {
    ...
    function drawBody(position, size, bodyElement) {
      var left = 0.8*(position.x - size/2) + 1110;
      var top = (position.y - size/2) + 1005;
    ...
    function fitToContainer(){
      ...
      canvasHeight = Math.min(window.innerHeight, window.innerWidth) - 400;
  ...
  var userInput = (function(){
    ...
    function formatMassForSlider(mass) {
      ...
      formatted = "Masse " + bodyNameFromIndex(currentMassSliderIndex) + " : " + formatted;
    ...
    function formatTimescaleForSlider(value) {
      ...
      formatted = "Simulationsgeschwindigkeit: " + formatted + " " + timeHumanized.unit + " pro Sekunde";
